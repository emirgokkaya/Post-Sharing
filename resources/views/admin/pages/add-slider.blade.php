...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('add_slider_post') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row mt-5">
                    ...
                    <div class="card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="8" cols="250" style="min-height:100px;max-height:200px;height:100%;width:100%;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
