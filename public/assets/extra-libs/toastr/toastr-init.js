$(function() {
    ...
    /*// Progress Bar
    $('#progress-bar-warning').on('click', function() {
        toastr.warning('Have fun storming the castle!', 'Progress Bar', { "progressBar": true });
    });

    $('#progress-bar-error').on('click', function() {
        toastr.error('Have fun storming the castle!', 'Progress Bar', { "progressBar": true });
    });

    $('#progress-bar-success').on('click', function() {
        toastr.success('Have fun storming the castle!', 'Progress Bar', { "progressBar": true });
    });

    $('#progress-bar-info').on('click', function() {
        toastr.info('Have fun storming the castle!', 'Progress Bar', { "progressBar": true });
    });*/
